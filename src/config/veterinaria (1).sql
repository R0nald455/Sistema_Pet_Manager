...
-- Tiempo de generación: 30-05-2023 a las 01:05:36
...
CREATE TABLE `tb_pet` (
  ...
  `petCode` varchar(3) DEFAULT NULL,
...
(3, '002', 'Toby', 2018, 'negro', 'Saludable'),
(5, '003', 'minino', 2020, 'negro y blanco', 'enfermo'),
(6, '4', 'Copito', 2013, 'blanco', 'Sano');
